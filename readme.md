...
**Note: This plugin is AI optimized BUT THIS IS STILL HUMAN-WRITEN CODE AND IT WILL STAY LIKE THAT FOREVER. REASON: THIS PLUGIN HAVE A LOT OF LINES AND SOMETIMES A BUG/PROBLEM APPEARS. I SOMETIMES NEED SOME HELP.**

[Primly](https://modrinth.com/organization/primly) | [Discord](https://discord.wejkey.org) | [Github](https://github.com/Primly-Project) | [Website](https://primly.wejkey.org)
